...
P(f'An earlier implementation generated a {F["n_associations"]}-association '
  f'candidate set across those seven contexts. We froze that set before '
  f'design-aware refitting, then used the final framework to re-audit its '
  f'evidence, scores and eligibility. The refit changed eight associations and '
  f'left {F["n_scoreable"]} scoreable. The framework recovered '
  ...
  f'prior urologic-oncology proposal to {F["funnel"]["survive"]} survivors '
  f'across two diseases, under a rule stated before it was applied.')
